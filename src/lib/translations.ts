...
export const translations: Record<Language, TranslationKeys> = {
  pt: {
    ...
    booking: {
      ...
      autoResponse: "Olá Zayin Tour! Gostaria de um orçamento para a viagem abaixo:",
      closingMsg: "Aguardo retorno com o orçamento. Obrigado!",
  ...
  es: {
    ...
    booking: {
      ...
      autoResponse: "¡Hola Zayin Tour! Me gustaría un presupuesto para el viaje a continuación:",
      closingMsg: "Espero su respuesta con el presupuesto. ¡Gracias!",
  ...
  en: {
    ...
    booking: {
      ...
      autoResponse: "Hello Zayin Tour! I would like a quote for the trip below:",
      closingMsg: "Looking forward to your quote. Thank you!",
